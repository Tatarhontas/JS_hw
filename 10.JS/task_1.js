...
// резолв
  ...
  p1.then((result) => console.log(result)).finally(() => console.log("finally"));
...
// реджект
  ...
  p2.catch((error) => console.log(error)).finally(() => console.log("finally"));
...
// 
  ...
  console.log(resolvePromise(p1));
  console.log(resolvePromise(p2));
